...
<head>
  ...
  {{-- trix editor --}}
  <link rel="stylesheet" type="text/css" href="<?=url('/')?>/public/css/trix.css">
  <script type="text/javascript" src="<?=url('/')?>/public/js/trix.js"></script>
          ...
          @if (auth()->user()->role=='admin' || auth()->user()->role=='superadmin')
            ...
            <li class="nav-item">
              <form action="<?=url('/logout/')?>" method="post">
                @csrf
                <button type="submit" class="nav-link"><i class="nav-icon fas fa-th"></i>Logout</button>
